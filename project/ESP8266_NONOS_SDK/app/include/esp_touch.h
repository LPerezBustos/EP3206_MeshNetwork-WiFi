...
#define ESP_TOUCH_TIME_ENTER         (2000)
// Time limit for ESP-TOUCH to receive config packets
#define ESP_TOUCH_TIMEOUT_MS         (40000)
// Total time limit for ESP-TOUCH
#define ESP_TOUCH_TIME_LIMIT         (2)
// Get into ESPTOUCH MODE only twice at most, then scan mesh if not connected
